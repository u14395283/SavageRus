...
namespace UnityTest.IntegrationTests
{
    ...
    public class PlatformRunnerSettingsWindow : EditorWindow
    {
        ...
        {
            EditorPrefs.SetString (Animator.StringToHash (UnityEngine.Application.dataPath + "uttTestScenes").ToString (), String.Join (",",m_IntegrationTestScenes.ToArray()));
            EditorPrefs.SetString (Animator.StringToHash (UnityEngine.Application.dataPath + "uttBuildScenes").ToString (), String.Join (",",m_OtherScenesToBuild.ToArray()));
        }
        
        private void LoadFromPrefereneces()
        {
            string storedTestScenes = EditorPrefs.GetString (Animator.StringToHash (UnityEngine.Application.dataPath + "uttTestScenes").ToString ());
            string storedBuildScenes = EditorPrefs.GetString (Animator.StringToHash (UnityEngine.Application.dataPath + "uttBuildScenes").ToString ());
